...
#### FIX DO TO <br>
- the board don't re-render after a card is created! need to fix this!!!
- need to improve css skills (my jedi sense tells me i can write those css files better than this)
- remove completely the state and create new actions to allow the DnD
